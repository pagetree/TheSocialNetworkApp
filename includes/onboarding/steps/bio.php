...
?>
            <div class="auth-field onboarding-bio-field">
                <textarea class="onboarding-bio-input" id="onboarding-bio-input" rows="5" maxlength="<?php echo PROFILE_BIO_MAX_LENGTH; ?>" placeholder="A few words about you…" aria-label="Bio"><?php echo htmlspecialchars($currentBio, ENT_QUOTES, 'UTF-8'); ?></textarea>
