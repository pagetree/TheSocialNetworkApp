...
<div class="post-stats-modal-overlay" id="post-stats-modal-overlay" hidden>
    ...
    >
        <button type="button" class="post-stats-modal-close" id="post-stats-modal-close" aria-label="<?php echo __e('stats.close'); ?>">
            <i data-lucide="x" aria-hidden="true"></i>
        </button>
        <header class="post-stats-modal-header">
            <h2 class="post-stats-modal-title" id="post-stats-modal-title"><?php echo __e('stats.title'); ?></h2>
        ...
        <div class="post-stats-modal-body" id="post-stats-modal-body">
            ...
            <p class="post-stats-modal-status" id="post-stats-modal-status"><?php echo __e('stats.loading'); ?></p>
        </div>
    </div>
</div>
